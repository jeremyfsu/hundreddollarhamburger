...
class AirportsControllerTest < ActionController::TestCase
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post :create, airport: { airport_id: @airport.airport_id, city: @airport.city, elev: @airport.elev, lat: @airport.lat, lon: @airport.lon, name: @airport.name, state: @airport.state }
    end
  ...
  test "should update airport" do
    patch :update, id: @airport, airport: { airport_id: @airport.airport_id, city: @airport.city, elev: @airport.elev, lat: @airport.lat, lon: @airport.lon, name: @airport.name, state: @airport.state }
    assert_redirected_to airport_path(assigns(:airport))
  end
